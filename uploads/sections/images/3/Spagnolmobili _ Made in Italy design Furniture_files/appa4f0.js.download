                        ...
                        if( data.stores ){
                            ...
                            for(var i=0; i<data.stores_count; i++) {
                                ...
                                if (item.macrocategoryStore) {
                                    html.find(".macrocategoryStore").css('background-color', 'black').css('color', 'white').css('padding', '1em')
                                }
                                ...
                                if( item.facebook == 'undefined' || item.facebook == 'null' || item.facebook == '' || item.facebook == null  || item.facebook == undefined ) {
                                    html.find(".facebookStore").addClass('hide');
                                }else{
                                    html.find(".facebookStore").attr('href', item.facebook);
                                }

                                if( item.instagram == 'undefined' || item.instagram == 'null' || item.instagram == '' || item.instagram == null  || item.instagram == undefined ) {
